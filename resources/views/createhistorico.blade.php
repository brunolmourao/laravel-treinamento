...
<html>
  ...
  <body>
    <div class="container">
     ...
     @endif
      @if(Auth::check())
      <form method="post" action="{{url('historico')}}" enctype="multipart/form-data">
        @csrf
        <div class="row">
        ...
        <div class="row">
          <div class="col-md-4"></div>
            <div class="form-group col-md-4">
              <label for="Email">Aprovado(0 ou 1):</label>
              <input type="text" class="form-control" name="aprovado">
            </div>
          </div>
        <div class="row">
          <div class="col-md-4"></div>
